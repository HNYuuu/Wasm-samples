(module
  ...
  (func $scanf (type 5) (param i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
    ...
    global.set $__stack_pointer
    local.get 1)
  (func $vscanf (type 5) (param i32 i32) (result i32)
    i32.const 1168
    i32.load
    local.get 0
    local.get 1
  ...
  (func $vfscanf (type 1) (param i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 15)
  (func $arg_n (type 5) (param i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $dlfree (type 4) (param i32)
    ...
    local.get 0
    i32.store)
  (func $dlrealloc (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
    ...
    call $dlfree
    local.get 2)
  (func $try_realloc_chunk (type 5) (param i32 i32) (result i32)
