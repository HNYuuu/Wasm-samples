(module
  ...
  (func $__uflow (type 0) (param i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 2)
  (func $getdelim (type 5) (param i32 i32 i32 i32) (result i32)
  ...
  (func $emscripten_stack_get_end (type 4) (result i32)
    global.get $__stack_end)
  (func $dynCall_jiji (type 10) (param $fptr i32) (param $0 i32) (param $1 i64) (param $2 i32) (result i64)
    local.get $0
    local.get $1
    local.get $2
    local.get $fptr
  ...
  (func $legalstub$dynCall_jiji (type 8) (param i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 5
    i32.wrap_i64)
  (func $legalfunc$__wasi_fd_seek (type 11) (param i32 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    i32.wrap_i64
    local.get 1
  ...
  (table (;0;) 7 7 funcref)
  (memory (;0;) 256 256)
  (global $__stack_pointer (mut i32) (i32.const 5245712))
  ...
  (elem (;0;) (i32.const 1) func $__stdio_seek $__stdio_write $__stdio_read $__stdio_close $__emscripten_stdout_close $__emscripten_stdout_seek)
  (data $.rodata (i32.const 1024) "/proc/cpuinfo\00Intel\00rb\00rwa\00\00(\04")
  (data $.data (i32.const 1056) "\10\0bP\00\00\00\00\00\05")
  (data $.data.1 (i32.const 1076) "\05")
  (data $.data.2 (i32.const 1100) "\02\00\00\00\06\00\00\00\08\07\00\00\00\04")
  (data $.data.3 (i32.const 1124) "\01")
  (data $.data.4 (i32.const 1139) "\0a\ff\ff\ff\ff")
  (data $.data.5 (i32.const 1208) "(\04"))
