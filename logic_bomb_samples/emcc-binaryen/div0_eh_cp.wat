(module
  ...
  (import "wasi_snapshot_preview1" "fd_seek" (func $legalimport$__wasi_fd_seek (type 14)))
  (func $__wasm_call_ctors (type 9)
    call $emscripten_stack_init
    call $init_pthread_self)
  (func $division_int__int_ (type 17) (param i32 i32) (result f64)
    (local i32 i32 f64)
  ...
  (func $dynCall_jiji (type 30) (param $fptr i32) (param $0 i32) (param $1 i64) (param $2 i32) (result i64)
    ...
    local.get $fptr
    call_indirect (type 11))
  (func $legalstub$dynCall_jiji (type 14) (param i32 i32 i32 i32 i32) (result i32)
    (local i64)
    local.get 0
    local.get 1
    local.get 2
