(module
  ...
  (func $logic_bomb (type 0) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 f64 f64 f64 f32 f32 f32 i32 i32 i32 i32 i32 i32 f32 f32 f32 i32 i32 i32 i32 i32 i32)
    ...
    f64.convert_i32_s
    local.set 9
    f64.const 0x1.0c6f7a0b5ed8dp-21 (;=5e-07;)
    local.set 10
    local.get 9
    local.get 10
    f64.add
