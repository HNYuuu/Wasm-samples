(module
  ...
  (import "wasi_snapshot_preview1" "fd_read" (func $__wasi_fd_read (type 11)))
  ...
  (func $logic_bomb (type 0) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 f64 f64 f64 f64 f64 f64 f32 f32 f64 f64 i32 i32 i32 i32 i32 i32 i32 i32)
  ...
  (func $__rem_pio2 (type 14) (param f64 i32) (result i32)
    (local i32 i64 i32 i32 f64 f64 f64 i32 i32 f64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
    local.tee 2
  ...
  (func $__sin (type 15) (param f64 f64 i32) (result f64)
    ...
    f64.add
    f64.sub)
  (func $floor (type 12) (param f64) (result f64)
    local.get 0
    f64.floor)
  ...
  (func $init_pthread_self (type 6)
    ...
    i32.const 0
    call $getpid
    i32.store offset=5776)
  (func $mbrtowc (type 11) (param i32 i32 i32 i32) (result i32)
                    ...
                    block  ;; label = @9
                      block  ;; label = @10
                        ...
                        block  ;; label = @11
                          ...
                          i32.const 0
                          i64.const -1
                          i64.store offset=6452 align=4
                          i32.const 0
                          i64.const 17592186048512
                          i64.store offset=6444 align=4
                          i32.const 0
                          local.get 1
                          i32.const 12
                          i32.add
            ...
            block  ;; label = @5
              block  ;; label = @6
                block  ;; label = @7
                  ...
                  i32.const 0
                  local.get 2
                  i32.store offset=6420
                  i32.const 0
                  local.get 6
                  i32.store offset=6416
                  i32.const 0
                  i32.const -1
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=6424 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=6416 align=4
                    i64.store offset=8 align=4
                    i32.const 0
                    local.get 8
                    i32.const 8
                    i32.add
                    i32.store offset=6424
                    i32.const 0
                    local.get 2
                    i32.store offset=6420
                    i32.const 0
  ...
  (table (;0;) 4 4 funcref)
  (memory (;0;) 256 256)
  (global $__stack_pointer (mut i32) (i32.const 5249344))
