(module
  ...
  (func $sn_write (type 1) (param i32 i32 i32) (result i32)
    ...
    i32.store offset=20
    local.get 2)
  (func $vsniprintf (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 160
    i32.sub
  ...
  (table (;0;) 6 6 funcref)
  (memory (;0;) 256 256)
  (global $__stack_pointer (mut i32) (i32.const 5245968))
