(module
  ...
  (func $__imported_wasi_snapshot_preview1_fd_close (type 2) (param i32) (result i32) unreachable)
  (func $__imported_wasi_snapshot_preview1_fd_read (type 3) (param i32 i32 i32 i32) (result i32) unreachable)
  (func $__imported_wasi_snapshot_preview1_fd_seek (type 4) (param i32 i64 i32 i32) (result i32) unreachable)
  (func $__imported_wasi_snapshot_preview1_proc_exit (type 5) (param i32) unreachable)
  (func $_start (type 6)
    (local i32)
    block  ;; label = @1
