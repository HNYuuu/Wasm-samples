(module
  ...
  (func $wctomb (type 3) (param i32 i32) (result i32)
    ...
    i32.const 0
    call $wcrtomb)
  (func $fmod (type 20) (param f64 f64) (result f64)
  ...
  (func $frexp (type 21) (param f64 i32) (result f64)
    ...
    local.get 0)
  (func $scalbn (type 21) (param f64 i32) (result f64)
    block  ;; label = @1
      block  ;; label = @2
        local.get 1
        i32.const 1024
