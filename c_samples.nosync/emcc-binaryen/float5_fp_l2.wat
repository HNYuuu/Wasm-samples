(module
  ...
  (import "wasi_snapshot_preview1" "fd_write" (func $__wasi_fd_write (type 11)))
  ...
  (func $logic_bomb (type 0) (param i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 3)
  (func $main (type 12) (param i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__floatscan (type 8) (param i32 i32 i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $hexfloat (type 15) (param i32 i32 i32 i32 i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $decfloat (type 16) (param i32 i32 i32 i32 i32 i32 i32)
  ...
  (func $scanexp (type 17) (param i32 i32) (result i64)
    ...
    local.get 4)
  (func $strtox (type 8) (param i32 i32 i32 i32)
    (local i32 i64 i64)
    global.get $__stack_pointer
    i32.const 160
    i32.sub
  ...
  (func $strtod (type 18) (param i32 i32) (result f64)
    ...
    global.set $__stack_pointer
    local.get 3)
  (func $atof (type 19) (param i32) (result f64)
    local.get 0
    i32.const 0
    call $strtod)
  ...
  (func $__unlock (type 3) (param i32)
    nop)
  (func $__extendsftf2 (type 20) (param i32 f32)
  ...
  (func $__fe_raise_inexact (type 1) (result i32)
    i32.const 0)
  (func $__letf2 (type 10) (param i64 i64 i64 i64) (result i32)
    (local i32 i64 i64)
    i32.const 1
    local.set 4
    block  ;; label = @1
    ...
    local.get 4)
  (func $__getf2 (type 10) (param i64 i64 i64 i64) (result i32)
    (local i32 i64 i64)
    i32.const -1
    local.set 4
    block  ;; label = @1
  ...
  (func $scalbn (type 23) (param f64 i32) (result f64)
    ...
    f64.reinterpret_i64
    f64.mul)
  (func $__fpclassifyl (type 24) (param i64 i64) (result i32)
    (local i64 i32)
    local.get 1
    i64.const 281474976710655
    i64.and
  ...
  (func $__fflush_unlocked (type 0) (param i32) (result i32)
    ...
    i32.const 0)
  (func $dynCall_jiji (type 25) (param $fptr i32) (param $0 i32) (param $1 i64) (param $2 i32) (result i64)
    local.get $0
    local.get $1
    local.get $2
    local.get $fptr
    call_indirect (type 7))
  (func $legalstub$dynCall_jiji (type 26) (param i32 i32 i32 i32 i32) (result i32)
    (local i64)
    local.get 0
    local.get 1
    local.get 2
  ...
  (table (;0;) 4 4 funcref)
  (memory (;0;) 256 256)
  (global $__stack_pointer (mut i32) (i32.const 5245200))
  ...
  (data $.data (i32.const 1112) "\05")
  (data $.data.1 (i32.const 1124) "\01")
  (data $.data.2 (i32.const 1148) "\02\00\00\00\03\00\00\00\08\05\00\00\00\04")
  (data $.data.3 (i32.const 1172) "\01")
  (data $.data.4 (i32.const 1187) "\0a\ff\ff\ff\ff")
  (data $.data.5 (i32.const 1256) "X\04"))
