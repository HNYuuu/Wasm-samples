(module
  ...
  (data $.data.2 (i32.const 1648) "\02\00\00\00\00\00\00\00\03\00\00\00\88\07\00\00\00\04")
  (data $.data.3 (i32.const 1692) "\ff\ff\ff\ff")
  (data $.data.4 (i32.const 1760) "\c0\12P\00\00\00\00\00\05")
  (data $.data.5 (i32.const 1780) "\04")
  (data $.data.6 (i32.const 1804) "\05\00\00\00\06\00\00\00\b8\0e\00\00\00\04")
  (data $.data.7 (i32.const 1828) "\01")
  (data $.data.8 (i32.const 1843) "\0a\ff\ff\ff\ff")
  (data $.data.9 (i32.const 1912) "\e8\06"))
