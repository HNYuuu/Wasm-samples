(module
  ...
  (func $fabs (type 12) (param f64) (result f64)
    local.get 0
    f64.abs)
  (func $pow (type 14) (param f64 f64) (result f64)
    ...
    f64.const 0x1.56e1fc2f8f359p-997 (;=1e-300;)
    f64.mul)
  (func $sqrt (type 12) (param f64) (result f64)
    local.get 0
    f64.sqrt)
