(module
  ...
  (data $.rodata (i32.const 1024) "-+   0X0x\00-0X+0X 0X-0x+0x 0x\00r\00nan\00inf\00NAN\00INF\00.\00(null)\00echo %d\0a")
  ...
  (data $.rodata.14 (i32.const 1620) "\03")
  (data $.rodata.15 (i32.const 1659) "\ff\ff\ff\ff\ff"))
