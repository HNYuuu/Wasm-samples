(module
  ...
  (func $__vfprintf_internal (type 8) (param i32 i32 i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 1)
  (func $printf_core (type 11) (param i32 i32 i32 i32 i32 i32 i32) (result i32)
  ...
  (func $getint (type 1) (param i32) (result i32)
    ...
    local.get 1)
  (func $pop_arg (type 5) (param i32 i32 i32 i32)
    block  ;; label = @1
      local.get 1
      i32.const 20
      i32.gt_u
  ...
  (elem (;0;) (i32.const 1) func $__emscripten_stdout_close $__stdio_write $__emscripten_stdout_seek)
  (data $.rodata (i32.const 1024) "-+   0X0x\00num_one <= num\00add_one\00Original number: %d\00After add one: %d\00source/overflow_but_check.c\00(null)\00\00\00P\06\00\00\11\00\0a\00\11\11\11\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\11\00\0f\0a\11\11\11\03\0a\07\00\01\00\09\0b\0b\00\00\09\06\0b\00\00\0b\00\06\11\00\00\00\11\11\11")
  (data $.rodata.1 (i32.const 1217) "\0b\00\00\00\00\00\00\00\00\11\00\0a\0a\11\11\11\00\0a\00\00\02\00\09\0b\00\00\00\09\00\0b\00\00\0b")
  (data $.rodata.2 (i32.const 1275) "\0c")
  (data $.rodata.3 (i32.const 1287) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data $.rodata.4 (i32.const 1333) "\0e")
  (data $.rodata.5 (i32.const 1345) "\0d\00\00\00\04\0d\00\00\00\00\09\0e\00\00\00\00\00\0e\00\00\0e")
  (data $.rodata.6 (i32.const 1391) "\10")
  (data $.rodata.7 (i32.const 1403) "\0f\00\00\00\00\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10\00\00\12\00\00\00\12\12\12")
  (data $.rodata.8 (i32.const 1458) "\12\00\00\00\12\12\12\00\00\00\00\00\00\09")
  (data $.rodata.9 (i32.const 1507) "\0b")
  (data $.rodata.10 (i32.const 1519) "\0a\00\00\00\00\0a\00\00\00\00\09\0b\00\00\00\00\00\0b\00\00\0b")
  (data $.rodata.11 (i32.const 1565) "\0c")
  (data $.rodata.12 (i32.const 1577) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c\00\000123456789ABCDEF")
  (data $.data (i32.const 1616) "\05")
  (data $.data.1 (i32.const 1628) "\01")
  (data $.data.2 (i32.const 1652) "\02\00\00\00\03\00\00\00\f8\06\00\00\00\04")
  (data $.data.3 (i32.const 1676) "\01")
  (data $.data.4 (i32.const 1691) "\0a\ff\ff\ff\ff"))
