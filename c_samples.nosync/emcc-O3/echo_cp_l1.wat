(module
  ...
  (func $vsiprintf (type 0) (param i32 i32 i32) (result i32)
    local.get 0
    i32.const 2147483647
    local.get 1
    local.get 2
    call $vsniprintf)
  (func $siprintf (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__vfprintf_internal (type 7) (param i32 i32 i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 1)
  (func $printf_core (type 8) (param i32 i32 i32 i32 i32 i32 i32) (result i32)
  ...
  (func $fmt_x (type 13) (param i64 i32 i32) (result i32)
    ...
    local.get 1)
  (func $fmt_o (type 5) (param i64 i32) (result i32)
    (local i32)
    local.get 0
    i64.eqz
    i32.eqz
    ...
    local.get 1)
  (func $fmt_u (type 5) (param i64 i32) (result i32)
  ...
  (func $sn_write (type 0) (param i32 i32 i32) (result i32)
    ...
    i32.store offset=20
    local.get 2)
  (func $vsniprintf (type 15) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 160
    i32.sub
  ...
  (table (;0;) 2 2 funcref)
  (memory (;0;) 256 256)
  (global $__stack_pointer (mut i32) (i32.const 5244864))
  ...
  (elem (;0;) (i32.const 1) func $sn_write)
  (data $.rodata (i32.const 1024) "-+   0X0x\00r\00(null)\00echo %d\0a\00\00\00\00\00\11\00\0a\00\11\11\11\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\11\00\0f\0a\11\11\11\03\0a\07\00\01\00\09\0b\0b\00\00\09\06\0b\00\00\0b\00\06\11\00\00\00\11\11\11")
  (data $.rodata.1 (i32.const 1137) "\0b\00\00\00\00\00\00\00\00\11\00\0a\0a\11\11\11\00\0a\00\00\02\00\09\0b\00\00\00\09\00\0b\00\00\0b")
  (data $.rodata.2 (i32.const 1195) "\0c")
  (data $.rodata.3 (i32.const 1207) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data $.rodata.4 (i32.const 1253) "\0e")
  (data $.rodata.5 (i32.const 1265) "\0d\00\00\00\04\0d\00\00\00\00\09\0e\00\00\00\00\00\0e\00\00\0e")
  (data $.rodata.6 (i32.const 1311) "\10")
  (data $.rodata.7 (i32.const 1323) "\0f\00\00\00\00\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10\00\00\12\00\00\00\12\12\12")
  (data $.rodata.8 (i32.const 1378) "\12\00\00\00\12\12\12\00\00\00\00\00\00\09")
  (data $.rodata.9 (i32.const 1427) "\0b")
  (data $.rodata.10 (i32.const 1439) "\0a\00\00\00\00\0a\00\00\00\00\09\0b\00\00\00\00\00\0b\00\00\0b")
  (data $.rodata.11 (i32.const 1485) "\0c")
  (data $.rodata.12 (i32.const 1497) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c\00\000123456789ABCDEF")
  (data $.rodata.13 (i32.const 1572) "\01")
  (data $.rodata.14 (i32.const 1611) "\ff\ff\ff\ff\ff"))
