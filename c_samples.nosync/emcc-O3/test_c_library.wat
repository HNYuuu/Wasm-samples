(module
  ...
  (type (;32;) (func (param f64) (result i64)))
  ...
  (func $__original_main (type 3) (result i32)
    ...
    local.get 0
    local.get 0
    i32.load16_u offset=275 align=1
    i32.store16 offset=276
    local.get 0
    i32.const 272
    i32.add
  ...
  (func $scanexp (type 21) (param i32 i32) (result i64)
    ...
    local.get 4)
  (func $strtox (type 12) (param i32 i32 i32 i32)
    (local i32 i64 i64)
    global.get $__stack_pointer
    i32.const 160
    i32.sub
    ...
    i32.add
    global.set $__stack_pointer)
  (func $strtod (type 22) (param i32 i32) (result f64)
    (local i32 f64)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $printf_core (type 28) (param i32 i32 i32 i32 i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 13)
  (func $out (type 29) (param i32 i32 i32)
    local.get 0
    i32.load8_u
    i32.const 32
    i32.and
  ...
  (func $fmt_x (type 30) (param i64 i32 i32) (result i32)
    (local i32)
    local.get 0
    i64.eqz
    i32.eqz
  ...
  (func $fmt_u (type 16) (param i64 i32) (result i32)
    ...
    local.get 1)
  (func $pad (type 31) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 256
    i32.sub
  ...
  (func $fmt_fp (type 15) (param i32 f64 i32 i32 i32 i32) (result i32)
    ...
    i32.gt_s
    select)
  (func $__DOUBLE_BITS (type 32) (param f64) (result i64)
    local.get 0
    i64.reinterpret_f64)
  ...
  (table (;0;) 8 8 funcref)
  (memory (;0;) 256 256)
  (global $__stack_pointer (mut i32) (i32.const 5248560))
  ...
  (elem (;0;) (i32.const 1) func $__stdio_close $__stdio_read $__stdio_seek $__emscripten_stdout_close $__stdio_write $__emscripten_stdout_seek $fmt_fp)
  (data $.rodata (i32.const 1024) "infinity\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00tutorialspoint\00Final destination string : %s\00This is string.h library function\00This is destination\00nan\00tutorialspoint.com\00inf\00abcdef\00This is source\00NAN\00INF\00ABCDEF\00sqrt testing below:\00abs testing below:\00floor testing below:\00exp testing below:\00ceil testing below:\0098993.489\00str1 is equal to str2\00str1 is less than str2\00str2 is less than str1\001234567890\00.\00(null)\00TechOnTheNet.com knows strncpy!\00Heloooo!!\00Enter character: \00Character entered: \00String after |%c| is - |%s|\0a\00The substring is: %s\0a\00The exponential value of %lf is %lf\0a\00String value = %s, Float value = %f\0a\00value of b = %d\0a\00value of a = %d\0a\00Float value = %f, String value = %s, test padding: %c\0a\00String value = %s, Float value = %f, test padding: %c\0a\00Value2 = %f \0a\00Value1 = %f \0a")
  (data $.rodata.1 (i32.const 1808) "TutorialsPoint\00\00\00\00\00\00Point\00\00\00\00\00\00\00http://www.tutorialspoint.com\00\00\00http://www.tutorialspoint.com")
  (data $.rodata.2 (i32.const 1922) "Hello, world!")
  (data $.rodata.3 (i32.const 1944) "\d0\09\00\00`\0a\00\00\d1t\9e\00W\9d\bd*\80pR\0f\ff\ff>'\0a\00\00\00d\00\00\00\e8\03\00\00\10'\00\00\a0\86\01\00@B\0f\00\80\96\98\00\00\e1\f5\05\18\00\00\005\00\00\00q\00\00\00k\ff\ff\ff\ce\fb\ff\ff\92\bf\ff\ff\00\00\00\00\00\00\00\00\11\00\0a\00\11\11\11\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\11\00\0f\0a\11\11\11\03\0a\07\00\01\00\09\0b\0b\00\00\09\06\0b\00\00\0b\00\06\11\00\00\00\11\11\11")
  (data $.rodata.4 (i32.const 2113) "\0b\00\00\00\00\00\00\00\00\11\00\0a\0a\11\11\11\00\0a\00\00\02\00\09\0b\00\00\00\09\00\0b\00\00\0b")
  (data $.rodata.5 (i32.const 2171) "\0c")
  (data $.rodata.6 (i32.const 2183) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data $.rodata.7 (i32.const 2229) "\0e")
  (data $.rodata.8 (i32.const 2241) "\0d\00\00\00\04\0d\00\00\00\00\09\0e\00\00\00\00\00\0e\00\00\0e")
  (data $.rodata.9 (i32.const 2287) "\10")
  (data $.rodata.10 (i32.const 2299) "\0f\00\00\00\00\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10\00\00\12\00\00\00\12\12\12")
  (data $.rodata.11 (i32.const 2354) "\12\00\00\00\12\12\12\00\00\00\00\00\00\09")
  (data $.rodata.12 (i32.const 2403) "\0b")
  (data $.rodata.13 (i32.const 2415) "\0a\00\00\00\00\0a\00\00\00\00\09\0b\00\00\00\00\00\0b\00\00\0b")
  (data $.rodata.14 (i32.const 2461) "\0c")
  (data $.rodata.15 (i32.const 2473) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c\00\000123456789ABCDEF")
  (data $.data (i32.const 2512) "\09")
  (data $.data.1 (i32.const 2524) "\01")
  (data $.data.2 (i32.const 2544) "\02\00\00\00\00\00\00\00\03\00\00\00\08\0b\00\00\00\04")
  (data $.data.3 (i32.const 2588) "\ff\ff\ff\ff")
  (data $.data.4 (i32.const 2656) "\05")
  (data $.data.5 (i32.const 2668) "\04")
  (data $.data.6 (i32.const 2692) "\05\00\00\00\06\00\00\00\18\0f\00\00\00\04")
  (data $.data.7 (i32.const 2716) "\01")
  (data $.data.8 (i32.const 2731) "\0a\ff\ff\ff\ff")
  (data $.data.9 (i32.const 2800) "0\16P"))
