(module
  ...
  (func $sin (type 0) (param f64) (result f64)
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $__rem_pio2 (type 4) (param f64 i32) (result i32)
  ...
  (func $__sin (type 5) (param f64 f64 i32) (result f64)
    ...
    f64.add
    f64.sub)
  (func $floor (type 0) (param f64) (result f64)
    local.get 0
    f64.floor)
  (func $__rem_pio2_large (type 6) (param i32 i32 i32 i32 i32) (result i32)
    ...
    i32.const 7
    i32.and)
  (func $__cos (type 7) (param f64 f64) (result f64)
    (local f64 f64 f64)
    f64.const 0x1p+0 (;=1;)
    local.get 0
    local.get 0
    ...
    f64.add
    f64.add)
  (func $scalbn (type 8) (param f64 i32) (result f64)
    block  ;; label = @1
      local.get 1
      i32.const 1024
      i32.ge_s
  ...
  (func $stackSave (type 1) (result i32)
    global.get $__stack_pointer)
  (func $stackRestore (type 9) (param i32)
    local.get 0
    global.set $__stack_pointer)
  (func $stackAlloc (type 10) (param i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    local.get 0
    i32.sub
  ...
  (table (;0;) 1 1 funcref)
  (memory (;0;) 256 256)
  (global $__stack_pointer (mut i32) (i32.const 5246768))
