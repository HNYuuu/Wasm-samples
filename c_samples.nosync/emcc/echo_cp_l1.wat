(module
  ...
  (func $shell (type 0) (param i32) (result i32)
  ...
  (func $__DOUBLE_BITS (type 28) (param f64) (result i64)
    local.get 0
    i64.reinterpret_f64)
  (func $vsnprintf (type 8) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 160
    i32.sub
  ...
  (table (;0;) 7 7 funcref)
  (memory (;0;) 256 256)
  (global $__stack_pointer (mut i32) (i32.const 5247200))
