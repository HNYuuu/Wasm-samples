(module
  ...
  (func $main (type 4) (param i32 i32) (result i32)
    ...
    local.get 2
    return)
  (func $fabs (type 11) (param f64) (result f64)
    local.get 0
    f64.abs)
  (func $pow (type 14) (param f64 f64) (result f64)
    ...
    local.get 2)
  (func $sqrt (type 11) (param f64) (result f64)
    local.get 0
    f64.sqrt)
